-- V008__schema_metadata_and_rag_tombstones.sql
--
...
VALUES (1, '0.0.0-bootstrap', 7, COALESCE(
    (SELECT applied_at FROM migrations_applied WHERE version = 7),
    (SELECT applied_at FROM migrations_applied ORDER BY version DESC LIMIT 1),
    '1970-01-01T00:00:00Z'
));

UPDATE schema_metadata
SET last_migration = 8,
    applied_at = COALESCE(
